function patch(config)
    config = sb.jsonMerge(config, {
		defaultCodexes = {
			...
			["sbq/meowscarada"] = { "protectorate1", "protectorate2" },
			["sbq/nickit_anthro"] = { "protectorate1", "protectorate2" },
