...
## Compatible Species
Unsupported races will still be able to use the controllers for the default available actions, but will not have any special animations when performing most of them.

All SBQ compatibility patches as well as a list of compatible species can be found [here](https://github.com/WasabiRaptor/SBQ-compatibility)
