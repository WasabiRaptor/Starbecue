...
function update(diskStore)
	...
	if diskStore.companions and diskStore.companions.companions then
		fixFollowers(diskStore.companions.companions.crew)
		fixFollowers(diskStore.companions.companions.shipCrew)
		fixFollowers(diskStore.companions.companions.followers)
	end
	return diskStore
end
